               ...
               <div className="arlo_tm_section" id="contact">
                    ...
                    <div className="arlo_tm_footer_contact_wrapper_all">
                                   ...
                                   <div className="leftbox">
                                        ...
                                        <div className="short_info_wrap">
                                             <ul>
                                                  ...
                                                  <li><p><label>Email:</label><span><a href="mailto:linhnguyenanh75@gmail.com">linhnguyenanh75@gmail.com</a></span></p></li>
                                                  <li><p><label>Phone:</label><span>+77 022 177 05 05</span></p></li>
                                                  <li><p><label>Github:</label><span><a href="https://github.com/anhlinh-II" target="_blank">github.com/anhlinh-II</a></span></p></li>
                                             </ul>
                                        </div>
                                   </div>
                         ...
                         <div className="arlo_tm_footer_wrap">
                              <div className="container">
                                   <p>&copy; Copyright 2024 by <strong style={{color: '#e3872d'}}>Anh Linh</strong>. All Rights are Reserved.</p>
                              </div>
                         </div>
                    </div>
               </div>
